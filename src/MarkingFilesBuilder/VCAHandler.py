    ...
    for line in VCAFileCOntent:
        ...
        if len(line) > 0:
            ...
            if counter:
                ...
                counter += 1
            if counter == 37:
                if 'TRCFTM' in dataValue.keys():
                    dataValue['TRCFMT'].update({tempList[3]: {'TRCFMT' : tempList, 'Shape' : radiusList}})
                else:
                    dataValue['TRCFMT'] = {tempList[3] : {'TRCFMT' : tempList, 'Shape' : radiusList}}    
